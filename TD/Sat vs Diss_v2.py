...
df.info()
# %%
df1 = df[['report_month', 'region',	'nps',	'id', 'ivdate1',
  	'ivdate2', 'main_operator',  'sat_reason_1', 
...
#%%
dfc_r = dfc_r.query('report_month >= "2022-11-01" and main_operator in \
